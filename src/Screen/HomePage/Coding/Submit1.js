...
<View style={{flexDirection:'row',gap:15}}>
    ...
    <View style={{backgroundColor:'#F7F3FF',marginVertical:10,padding:18,alignItems:'center',borderBottomRightRadius:10,borderBottomLeftRadius:10,height: 60, width: 149,marginTop:-6}}>
