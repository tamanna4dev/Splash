...
const VideoLectures = () => {
  return (
        ...
        <Text style={{color:'#FF5773',fontWeight:600,fontSize:22,textAlign:'center',marginVertical:10}}>Videos</Text>
    <Image source={require('../../Assets/image/40.png')} style={{ height: 165, width: 315}} />

   
<View  style={{backgroundColor:'rgba(33, 33, 33, 0.6)',padding:10,borderBottomLeftRadius:8,borderBottomRightRadius:8,marginTop:-61}}>
...
<View  style={{backgroundColor:'rgba(33, 33, 33, 0.6)',padding:10,borderBottomLeftRadius:8,borderBottomRightRadius:8,marginTop:-64}}>
